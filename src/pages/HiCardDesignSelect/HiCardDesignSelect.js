...
function HiCardDesignSelect() {
  return (
    <div class="item--zHs">
  <div class="auto-group-fram-hi5">
    <p class="item--74y">신규 Hi:Card 신청</p>
    <p class="item--PYH">카드 디자인을 선택해주세요</p>
    <div class="group-1000003245-FaV">
      <div class="auto-group-xpr7-Nf7">
        <div class="group-1000003019-JHs">
          <div class="cards-vertical-qYh">
            <div class="auto-group-dsr5-wLq">
              {/* <img class="paste-image-here-tG5" src="./assets/paste-image-here-fU1.png"/> */}
              <div class="shape-9xh">
              </div>
          ...
          <p class="the-pink-neH">the Pink</p>
        </div>
      ...
      <div class="group-1000003024-ebw">
        <div class="cards-vertical-zA1">
          <div class="auto-group-qysf-hKK">
            {/* <img class="paste-image-here-dTs" src="./assets/paste-image-here.png"/> */}
            <div class="shape-Lt5">
            </div>
        ...
        <div class="group-1000003023-Lys">
          <div class="cards-vertical-tkV">
            <div class="auto-group-hy1w-p8M">
              {/* <img class="paste-image-here-N9s" src="./assets/paste-image-here-Bpq.png"/> */}
              <div class="shape-FzM">
              </div>
    ...
    <div class="group-1000003168-yBb">
      <div class="group-1000003161-Vfj">
        <div class="group-1000003158-ioP">X BOOST 선택</div>
      </div>
    </div>
  </div>
</div>
